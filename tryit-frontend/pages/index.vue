  ...
  <div>
    <section class="welcome">
      ...
      <div class="welcome-content">
        ...
        <h4>ETSIINF - UPM</h4>
        <h3>19-25 MARZO</h3>
        <Button :type="'secondary-btn'" :text="'Consigue tu entrada'"></Button>
      </div>
    </section>
      ...
      <div class="properties">
        ...
        >
          ...
          <div class="description">
            <p>Como en otras ediciones, este año también contaremos con empresas líderes de la talla de Google, Microsoft, IBM y muchas más.</p>
          </div>
          <div class="icon">
            <div class="bck"></div>
        ...
        >
          ...
          <div class="description">
            <p>Podrás asistir a charlas y talleres de programación web, Big Data, Blockchain, aplicaciones móviles, VR...</p>
          </div>
          <div class="icon">
            <div class="bck"></div>
            <i
        ...
        >
          ...
          <div class="description">
            <p>Podrás asistir a una amplia variedad de charlas y talleres donde podrás aumentar tus conocimientos</p>
          </div>
          <div class="icon">
            <div class="bck"></div>
        ...
        >
          ...
          <div class="description">
            <p>Try IT! lo organiza DA-ETSIINF de la UPM. Está hecho por y para estudiantes. Perseguimos la formación y no el lucro.</p>
          </div>
          <div class="icon">
            <div class="bck"></div>
        ...
        >
          ...
          <div class="description">
            <p>Try IT! se incluye en el Catálogo General de Reconocimiento de Créditos de la UPM. Podrás obtener hasta 2 ECTS.</p>
          </div>
          <div class="icon">
            <div class="bck"></div>
