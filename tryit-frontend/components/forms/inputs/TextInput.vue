...
export default class TextInput extends Vue {
	...
	defaultStatus: StatusOnInput = this.status
...
[type="text"] {
	...
	box-shadow: var(--box-shadow-input-inset), var(--box-shadow-on-light-bck-light);
}
...
[type="text"].ok {
	...
	box-shadow: var(--box-shadow-input-inset-ok), var(--box-shadow-on-light-bck-light-ok);
...
[type="text"].error {
	...
	padding-left: var(--space-s);
	box-shadow: var(--box-shadow-input-inset-error), var(--box-shadow-on-light-bck-light-error);
	color: var(--error-1);
...
[type="text"].info {
	...
	padding-left: var(--space-s);
	box-shadow: var(--box-shadow-input-inset-info), var(--box-shadow-on-light-bck-light-info);
}
